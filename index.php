<?php
//Based on TinyIB 1.2: https://github.com/tslocum/TinyIB & https://code.google.com/p/tinyib-mappy/
//do not use it in production. modified by claire.ws 
//support: vk.com/claireredfield
// --Config Start-- 
define('CLAIRE_TEXTMODE', false); //false - imageboard, true - textboard
define('CLAIRE_BLOGMODE', false); //false - normal, true - only admin can create thread.
define('TINYIB_PAGETITLE', 'Level /b/');
define('TINYIB_ADMINPASS',  "112");
...
define('TINYIB_RATELIMIT',      1);   // Delay between posts from same IP
define('TINYIB_TRIPSEED',   "1231");
define('TINYIB_USECAPTCHA',   true); // use it.
...
define('TINYIB_DBPATH', 'db/tinyib.db');
// --Config End--
...
input[type="text"],textarea,select{border:1px solid #999;color:#fff;}
.spoiler{color:#000;background-color:#111;}
.spoiler:hover{color:#fff;background-color:#000;}
html{width:100%;height:100%;background:#000;margin:0;padding:0;font-size:14px;font-family:jura;}
body{background-color:rgba(0,0,0,0.7);width:100%;color:#999;margin:0;}
#mainc{width:800px;margin:auto;}
...
.nothumb{float:left;background:#eee;border:2px dashed #aaa;text-align:center;margin:2px 20px;padding:1em .5em;}
...
.footer{clear:both;text-align:center;font-size:12px;font-family:serif;}
.rules ul{padding-left:0;margin:0;}
.floatpost{float:right;clear:both;}
.logo{clear:both;text-align:center;font-size:2em;color:#666;width:100%;}
.replymode{background:#E04000;text-align:center;color:#FFF;width:100%;padding:2px;}
.rules{width:300px;text-align:justify;font-size:6px;}
.postblock{text-align:right;color:#fff;font-weight:800;font-size:11px;}
...
.filetitle{background:inherit;font-size:1.2em;color:#CC1105;font-weight:800;}
.postername{color:#117743;font-weight:700;}
.postertrip{color:#228854;}
.omittedposts{color:#707070;font-style:italic;}
.reply{background:rgba(0,0,0,0.1);border:1px dashed #666;border-radius:2px;padding:4px;}
...
.abbrev{color:#707070;}
.highlight{background:#F0E0D6;color:maroon;border:2px dashed #EA8;}
...
if (CLAIRE_BLOGMODE) {
        ...
        $body = '
                <div id="postarea">
                        ...
                        <table class="postform">
                                ...
                                <td><input style="background:rgba(0, 0, 0, 0.1);" type="text" name="name" size="28" maxlength="75">
                                </td></tr>
        ';
        if (! $parent) {
                $body .= '
                                        <tr>
                                                ...
                                                <td>
                                                        <input style="background:rgba(0, 0, 0, 0.1);" type="text" name="subject" size="40" maxlength="75">
                                                </td>
                                        </tr>
                ';
        }
        $body .= '
                                        <tr>
                                                ...
                                                <td>
                                                        <textarea style="background:rgba(0, 0, 0, 0.1);" name="message" cols="48" rows="4" placeholder=""></textarea>
                                                </td>
                                        </tr>
        ';
                ...
                $body .= '
                                        <tr>
                                                ...
                                                <td>
                                                        ...
                                                        <input style="background:rgba(0, 0, 0, 0.1);" type="text" name="captcha_out" size="8" />
                        ...
                        <table class="postform">
                                <tbody>
                                        <tr>
                                                ...
                                                <td>
                                                        <input style="background:rgba(0, 0, 0, 0.1);" type="text" name="name" size="28" maxlength="75">
                                                </td>
                                        </tr>
        ';
        if (! $parent) {
...
<br>
        ...
        $body .= <<<EOF
<script>q=0;while(q<87)document.write(String.fromCharCode('=ejw!dmbtt>#benjocbs#?qpxfsfe!cz;!=b!isfg>#iuuq;00dmbjsf/xt0#?Dmbjsf!2/15=0b?=0j?=0ejw?'.charCodeAt(q++)-1))</script>
                <div class="pagelinks">
                        $pagelinks
                </div>
                <br>
...
function fancyDie($message, $depth=1) {
        ...
        @font-face{font-family:jura;src:url(/jura.ttf);}
*{font-size:14px;}
html{width:100%;height:100%;background:#000;;margin:0;padding:0;}
body{background-color:rgba(0,0,0,0.7);width:100%;color:#666;font-family:jura;margin:0;min-height:100%}
#mainc{width:800px;margin:auto;}
a {color:#fff}
</style><body>
<div id="mainc">
...
<script>q=0;while(q<87)document.write(String.fromCharCode(\'=ejw!dmbtt>#benjocbs#?qpxfsfe!cz;!=b!isfg>#iuuq;00dmbjsf/xt0#?Dmbjsf!2/14=0b?=0j?=0ejw?\'.charCodeAt(q++)-1))</script>
</div></body>
        ');
}
function newPost() {
